...
#habitat data
habitat<-read.csv("growth-precip-thailand/data/HKK-other/HKK_habtype(in).csv")
...
hkk_elev<-read.table("growth-precip-thailand/data/HKK-other/CTFSElev_hkk.rdata")
...
elev_rast<-rast(hkk_elev$col.elev, nrows=100, ncols=100, xmin=0, xmax=100, ymin=0, ymax=100)
```
