...
![](display/Fig_SI_species_sensitivities.png)

![](display/Fig_SI_sensitivity_cor_dec.png)

![](display/Fig_trait_intercept_plot.png)

\newpage

## Individual growth and correlations

- Negative growth proportions across the years

![](display/sens_corr.png)
