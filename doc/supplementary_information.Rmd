...
![**Figure S1:** Raw climate data timeseries from 2009 to 2023 from ERA5Land and CHIRPS. Measurements represent daily rolling means over a 30-day time window for precipitation, max temperature and VPD and rolling sum for number of dry days. The shaded areas indicate the three drought years analysed - 2010, 2015 and 2020.](display/climvars_fullseries_remote.png)

![**Figure S2:** Climate anomalies for all variables from 2009 to 2020. Values represent number of standard deviations from the long-term mean for daily rolling mean values. The shaded areas indicate the three drought years analysed - 2010, 2015 and 2020.](display/climvars_anomalies_fullseries_remote.png)
...
![**Figure S4:** Species sensitivities in drought years 2010, 2015 and 2020. Boxplots represent 25th, 50th (median) and 75th percentile of sensitivity for each species in each year and whiskers represent 95% CIs. All individual sensitivities represented by jittered points.](display/Fig_SI_species_sensitivities.png)
...
![**Figure S7:** Map of trees with dendrobands in HKK, included in analyses in the 2010, 2015 and 2020 datasets](display/dendro_tree_map.png)

![**Figure S8:** Calculated Topographic Wetness Index (TWI) values for the HKK plot](display/twi.png)

![**Figure S9:** Distribution of DBH with Crown Illumination Index (CII) in 2014.](display/dbh_cii.png)
...
![**Figure S13:** Testing correlations for DBH $\perp\!\!\!\perp$ TWI by species](display/cond_dep_dbh_twi.png)  

![**Figure S14:** Testing correlations for CII $\perp\!\!\!\perp$ TWI by species](display/cond_dep_cii_twi.png)
...
![**Figure S18:** Model results from three independent causal inquiry models of sensitivity following backdoor criteria for total causal effect of DBH, CII and TWI with species random effect on intercept and slope.](display/causal_inquiry.png)
