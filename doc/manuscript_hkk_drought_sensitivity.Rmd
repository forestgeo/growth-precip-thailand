...
Tropical tree woody growth has long-lasting impacts on the terrestrial carbon pool, but it may be vulnerable to climate anomalies like drought [@tao_increasing_2022].  
...
- Across the tropics, drought frequency and intensity are increasing, and there is some evidence that stand-level vulnerability is increasing [@luo_tropical_2022; @tao_increasing_2022].
- Drought sensitivity is often understood as a species trait, but it can vary substantially among drought events [] and among individuals based on their characteristics[@bennett_larger_2015, @mcgregor_tree_2021], compounding uncertainties in predicting forest responses.  
...
- Tree growth in both everwet and seasonally dry tropical forests show predictable seasonal patterns [@garcía-cervigón_climate_2020, @giraldo_tree_2023], but with differences among these patterns.
...
- The effect of drought timing can be more pronounced in seasonally dry tropical forests because of strong seasonality in climate and consequently on photosynthesis, allocation and growth (including dry seasons unfavourable to growth).   
- They are also at thermal/water stress tolerance thresholds, making them more vulnerable to drought [@allen_will_2017], potentially explaining stand-level patterns
of drought-associated water stress  [@bauman_tropical_2022; @bennett_sensitivity_2023; @aguirre-gutiérrez_drier_2019].
- However, trees in seasonally dry tropical forests exhibit a mix of strategies - along a spectrum of conservative to acquisitive water-use - that support survival and growth despite strong seasonal hot/dry stress, which might confer differential advantages in drought conditions.
<!-- - Trees in seasonally dry forests are routinely exposed to hot, dry conditions in the dry season and may have evolutionary strategies like dry-season deciduousness and <!-- - Morevoer, besides broad patterns at the stand level, species- and individual-level heterogeneity can lead to divergent responses with consequences for stand composition.   
