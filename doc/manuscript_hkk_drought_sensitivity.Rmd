...
Tree species have diverse evolutionary strategies <!--that span and interact across timescales --->to cope with dry conditions, often leading to their classification as "drought tolerant" or "drought sensitive" [@refs].
...
For example, some species regulate negative $\pi_{tlp}$s, leaf deciduousness, and root depth based on environmental cues, leading to intraspecific or interannual variation potentially and potentially resulting in spatiotemporal variation in drought responses [@williams_deciduousness_2008; REFS Lasky? Hulshof?]. 
...
This results in greater biophysical stress on trees that have exposed crowns [@vinod_thermal_2023] or rely on more ephemeral (typically shallower) water sources that are severely diminished under drought [@refs].<!--I (KAT) made a substantive change here. It's not necessarily the case that shallow-rooted trees or trees in dry microenvironments suffer more, as they'd also tend to have adaptations to handle those conditions.--> 
Consequently, larger trees, with more exposed crowns, suffer more growth declines during drought [@bennett_larger_2015] (**see issue [#24](https://github.com/forestgeo/growth-precip-thailand/issues/24)**)<!--; larger trees have more exposed crowns although crown exposure can allow access to light and increase growth in normal years-->. 
