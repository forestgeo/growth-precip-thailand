...
# Abstract (150 words) {-}
The frequency and intensity of droughts are increasing across forests worldwide, altering tree demography and its contribution to the land carbon sink. 
In seasonally dry tropical forests, species adaptations to strong dry seasons might confer drought resistance, but this resistance may be variable with individual microenvironments and across drought events. 
...
Understanding these impacts is an important research priority, particularly for tropical forests, which <!--harbor high species diversity and --> are critical C sinks; tropical tree woody growth removes roughly `r round (150*1/6,0)` Gt CO~2~ annually offsetting ~`r round(7/36.3*100,-1)`% of anthropogenic fossil fuel emissions [@beer_terrestrial_2010;@anderson-teixeira_carbon_2021;@anderson-teixeira_carbon_2016;@brando_droughts_2019].
Drought events can threaten this sink; the 2015-2016 ENSO drought in the Amazon temporarily shifted the region from a net sink to a net source of carbon [@brando_droughts_2019].
However, nuanced study of tropical tree woody growth responses to drought is inhibited by the fact that few tropical species form rings and long-term annual records are rare [@zuidema_tropical_2022]. 
Separate studies have shown that drought characteristics species traits, and microenvironment all affect tree growth responses [@bennett_larger_2015;@mcgregor_tree_2021], but we know little about their combined effects or potential interactions, which could fundamentally alter our understanding of forest responses to drought. 
...
Droughts are notoriously hard to define and encompass a variety of types based on the meteorogical or climatic variables affected [@slette_how_2019]. 
...
Tree growth responses to drought timing can be pronounced in seasonally dry tropical forests because of strong seasonality in climate and consequently on photosynthesis, allocation and growth (including dry seasons unfavourable to growth) [@garcía-cervigón_climate_2020]. 
...
Seasonally dry tropical forests are also at thermal and water stress tolerance thresholds for many species, making them more vulnerable to drought [@allen_will_2017], and leading to stand-level patterns of drought-associated water stress [@bauman_tropical_2022; @bennett_sensitivity_2023; @aguirre-gutiérrez_drier_2019]. 
...
Tree species in seasonally dry forests have diverse evolutionary strategies <!--that span and interact across timescales --->to maximise growth and survival under periodic hot/dry conditions. 
These strategies can range along a spectrum from hydraulic safety to efficiency leading to tolerance or avoidance of dry conditions[@gonzález-m._diverging_2021]. 
...
Besides decrease in magnitude of growth, the proportion of trees with negative growth was also higher in the drought years (Fig S--). 
...
Species median sensitivities in 2010 and 2015 were not correlated with each other (Pearson's correlation coefficient r = `r round(sens.sp.cor[4]$estimate, 2)`, p = `r round(sens.sp.cor[3]$p.value,2)`, Fig S--) but on average had lower mean and median sensitivities in 2015 than in 2010 (Fig S--), in alignment with median sensitivities across all trees. 
...
*Afzelia xylocarpa*, one of the few annual-ring-forming species in HKK is noteworthy with the most distinct response across the two events; it had the highest (positive) sensitivity in the dry season drought, but a large negative sensitivity in the wet season drought (Fig S--). 
