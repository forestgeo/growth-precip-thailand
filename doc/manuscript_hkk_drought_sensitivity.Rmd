...
- *In forests worldwide, intense drought is becoming more frequent, affecting forest demography, diversity, and  C cycling.*
- *Understanding these impacts is an important research priority, particularly for tropical forests, which harbor high species diversity and are critical in the global C cycle.* 
...
- *We know that drought characteristics, species traits, and microenvironment all affect tree growth responses.* 
...
- *Specifically, if drought tolerance is influenced independently by drought characteristics, species traits, and microenvironment, it is relatively straightforward to predict tree drought responses; for example, we'd expect a species that has proved relatively resistant to past droughts to be among the most drought-resistant species in any microhabitat and through any drought. *
- *In contrast, if these factors interact, the species and individuals that exhibit resistance to one drought may prove much more vulnerable in the next. The resultant amplification of the complexity and diversity of drought responses may act as a mechanism for promoting species diversity and stabilizing ecosystem function as drought regimes intensify.*

<!--PREVIOUS INTRO PARAGRAPH ON IMPORTANCE OF DROUGHT, HOW OUR UNDERSTANDING REMAINS LIMITED, PARTICULARLY FOR SEASONAL TROPICAL FORESTS-->
- Tropical tree woody growth has long-lasting impacts on the terrestrial carbon pool, but is vulnerable to climate anomalies like drought [@tao_increasing_2022].  
...
- However, tree growth is increasingly vulnerable to drought, the frequency and intensity of which are increasing across the much of tropics [@tao_increasing_2022]. <!--and there is some evidence that stand-level vulnerability is increasing [@luo_tropical_2022; @tao_increasing_2022].-->
- (We don't know very much about woody growth responses, as few tropical species form rings and long-term annual records are rare [@zuidema_tropical_2022].)
...
- Tree growth in both everwet and seasonally dry tropical forests show predictable seasonal patterns [@garcía-cervigón_climate_20200; @giraldo_tree_2023], but with differences among these patterns.
...
<!--PARAGRAPHS ON HOW SPECIES TRAITS AND INDIVIDUAL CHARACTERISTICS SHAPE DROUGHT RESPONSES (SEPARATE SPECIES AND MICROENVIRONMENT)-->
