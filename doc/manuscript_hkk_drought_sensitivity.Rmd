...
While the meteorological data justify our characterization of these droughts as "dry-season" (2010) and "wet-season" (2015), growth records from numerous additional droughts would be necessary to rigorously generalize differences based on the seasonality of drought.
...
Studies in temperate forests have confirmed that drought characteristics including seasonal timing, duration, and severity affect tree growth responses [@gao_dynamic_2018; @dorangeville_drought_2018] and that effects of species, species traits, tree size, and microenvironment can differ across droughts [@mcgregor_tree_2021].
As tropical dendrometer band records continues to grow, so will the potential to better understand how drought characteristics interact with species traits and microenironment to shape growth respones. 
