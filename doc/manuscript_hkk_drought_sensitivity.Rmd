...
We used the raw window size measurements combined with the diameter measurement at installation $(dia_{1})$ to calculate diameter at each dendroband census using standard equations that uses the chord across the measurement window to estimate the arc, assuming a circular cross section[@condit_dendrometer_].
...
We used daily weather data on maximum temperate, relative humidity and total precipitation collected from 2001 to 2019 at the Forest Fire Research Station <!--[CHECK WHERE]-->, located ~20 km from the ForestGEO plot. 
...
$$
We then calculated rolling means of precipitation, number of dry days (precipitation = 0), VPD and maximum temperature over 30 day periods across the whole year for each year.
