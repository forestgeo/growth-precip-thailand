...
While forest drought responses are often considered to follow consistent patterns across droughts [e.g.,@bennett_larger_2015; @brando_droughts_2019], droughts with different characteristics may in fact have very different effects on tree growth [@gao_dynamic_2018].
...
These aboveground gradients in crown exposure are at least partially offset by the tendency for large trees to have larger and often deeper root systems and greater stem water storage [@fernández-de-uña_role_2023] and thereby potential to access more reliable water sources [@stahl_depth_2013].
