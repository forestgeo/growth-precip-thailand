...
- It remains poorly understood the extent to which this is shaped by tree size itself, crown exposure, water access, and traits that tend to covary with size (e.g., decidiousness) -- all of which interact to shape drought resistance
...
-Removed measures with large decimal errors, large outliers (> 3 SD). 
- For all individuals with three points of measurements for each drought, calculated raw increment as difference between relevant censuses to get pre-drought increment and drought-year increment.
- Resistance - difference between pre-drought and drought-year increment

*Tree size*
- calculated DBH for at the start of the pre-drought year from dendrometer band window
