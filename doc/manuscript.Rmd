...
![***Figure 1. Climatic characteristics of drought years and average years*** in Huai Kha Khaeng ForestGEO plot. For comments - https://github.com/forestgeo/growth-precip-thailand/issues/10](display/Fig1_alt.png)
...
$$
sensitivity \sim DBH + CII + TWI + size + (DBH+CII+TWI | Species)
$$ 
