...
$sensitivity_{tree} \sim DBH_{0} + TWI + CII_{0} + (1|Species)$

2. varying intercepts + predictors scaled within species  
$sensitivity_{tree} \sim DBH_sp_{0} + TWI_sp + CII_sp_{0} + (1|Species)$

3. varying slopes + predictors scaled within species  
$sensitivity_{tree} \sim DBH_sp_{0} + TWI_sp + CII_sp_{0} + (1+DBH+CII+TWI|Species)$
